      ...
      <div class="row">
        ...
        <div class="col-sm-3">
          <div class="form-group">
            ...
            <input name="coordinat_wilayah" value="<?= $web['coordinat_wilayah'] ?>" class="form-control"
              placeholder="Coordinat Wilayah">
          </div>
        </div>
        ...
        <div class="col-sm-2">
          <div class="form-group">
            ...
            <input type="number" value="<?= $web['zoom_view'] ?>" name="zoom_view" min="0" max="20" class="form-control"
