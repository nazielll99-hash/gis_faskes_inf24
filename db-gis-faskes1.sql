...
CREATE TABLE `tbl_wilayah` (
  ...
  `nama_wilayah` varchar(150) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
  `geojson` text CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci,
